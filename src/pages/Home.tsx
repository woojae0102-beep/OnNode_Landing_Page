...
export default function Home() {
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div {...fadeInUp} className="max-w-3xl mx-auto mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
              {[
                "스토어는 개설 했는데 무엇 부터 해야 할지 모르는 초보 셀러",
                "꽤나 많은 광고 비용을 지출하고 있지만 광고비용 대비 효율이 낮은 대표님",
                "상품은 좋은데 콘텐츠 제작 방향을 잡지 못하는 대표님",
                "효율적인 광고 집행을 데이터를 통한 전략이 필요한 대표님",
                "글로벌 시장에 진출을 원하지만 방법도 언어도 준비가 안된 대표님",
                "스토어 운영에 있어서 적자를 격고 있는 대표님",
              ].map((text, idx) => (
                <div
                  key={idx}
  ...
  <div className="container mx-auto px-4 text-center text-muted-foreground">
    ...
    <div className="flex justify-center gap-8 text-xs">
      <a 
        href="https://onnode-ai365.netlify.app/terms.html" 
        target="_blank"
      ...
      <a 
        href="https://onnode-ai365.netlify.app/privacy.html"
        target="_blank"
        rel="noopener noreferrer"
        className="hover:text-foreground transition-colors"
      >
      ...
      <a 
        href="https://onnode-ai365.netlify.app/refund.html"
        target="_blank"
        rel="noopener noreferrer"
        className="hover:text-foreground transition-colors"
      >
